...
<head>
  ...
  <style>
    * {
    ...
    .hero-panel {
      --hero-image: url('https://images.pexels.com/photos/2294361/pexels-photo-2294361.jpeg?auto=compress&cs=tinysrgb&w=1600&h=1200&dpr=1');
      position: relative;
      overflow: hidden;
      display: flex;
...
<script>
  ...
  const roleConfig = {
    user: {
      label: 'Pemain',
      heroImage: "url('https://images.pexels.com/photos/2294361/pexels-photo-2294361.jpeg?auto=compress&cs=tinysrgb&w=1600&h=1200&dpr=1')"
    },
    owner: {
